    ...
    <div className="navbar fixed w-full bg-gray-100 z-50 shadow-sm">
      ...
      <div className="navbar-start">
        ...
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-white rounded-lg w-52"
          >
            {navLinks}
          </ul>
        </div>
      ...
      <div className="navbar-end flex items-center space-x-4">
        ...
        {user ? (
          <div className="dropdown dropdown-end">
            ...
            >
              ...
              <li>
                <button
                  onClick={logOut}
                 className="btn bg-cyan-400 text-white hover:bg-blue-500"
                >
                  Logout
                </button>
              </li>
          ...
          <Link to="/login">
            <button className="btn bg-cyan-400 text-white hover:bg-cyan-500">
              Join Us
            </button>
          </Link>
        )}
